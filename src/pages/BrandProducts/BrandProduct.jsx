    ...
    return <div className='border-2 rounded-lg pb-7 p-5'>
        ...
        <div>
            ...
            <div className='flex justify-evenly mt-5'>
                ...
                <div>
                    <p className='font-semibold text-lg mb-3'>Category: <span className='font-normal text-gray-500'>{type}</span></p>
            ...
            <div className='mt-2 flex mx-6 justify-between'>
                <button className='bg-red-500 px-3 py-2 rounded text-white font-medium cursor-pointer'>Update</button>
                <button className='bg-green-600 px-3 py-2 rounded text-white font-medium cursor-pointer'>Details</button>
            </div>
        </div>
    </div>
}
