    ...
    return <>
        ...
        <footer className="footer p-10 bg-base-200 text-base-content">
            <nav>
                ...
                <a className="link link-hover">ByteSync store</a>
                <a className="link link-hover">No. 1259 Freedom, New York</a>
                <a className="link link-hover">United States</a>
                <a className="link link-hover">+91-987654321</a>
                <a className="link link-hover">info@bytesync.com</a>
            </nav>
            <nav>
            ...
            <nav>
                <header className="footer-title text-xl">Customer Service</header>
                <a className="link link-hover">Help Center</a>
                <a className="link link-hover">Redeem Voucher</a>
                <a className="link link-hover">Contact Us</a>
                <a className="link link-hover">Policies and Rules</a>
            </nav>
        </footer>
        <footer className="footer px-10 py-4 border-t bg-base-200 text-base-content border-base-300">
            <aside className="items-center grid-flow-col">
                <p>Copyright &copy; 2023, ByteSync group. All rights reserved.</p>
            </aside>
